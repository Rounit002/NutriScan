...
export const getNutritionChips = (item = {}, servings = 1) => {
  ...
  return [
    { key: 'calories', icon: '🔥', label: 'Calories', value: `${formatNumber(nutrition.calories)} kcal` },
    { key: 'protein', icon: '💪', label: 'Protein', value: `${formatNumber(nutrition.protein, 1)}g` },
    { key: 'carbs', icon: '🌾', label: 'Carbs', value: `${formatNumber(nutrition.carbs, 1)}g` },
    { key: 'sodium', icon: '🧂', label: 'Sodium', value: `${formatNumber(nutrition.sodium)}mg` },
    { key: 'fats', icon: '🫙', label: 'Fats', value: `${formatNumber(nutrition.fats, 1)}g` },
  ];
};
