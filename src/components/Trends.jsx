                ...
                >
                  <defs>
                    <linearGradient id="colorScore" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="#4B6F44" stopOpacity={0.15} />
                      <stop offset="95%" stopColor="#4B6F44" stopOpacity={0} />
                    </linearGradient>
                  </defs>
                  <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="var(--ns-border-light)" />
                  <XAxis
                    dataKey="displayDate"
                    axisLine={false}
                    tickLine={false}
